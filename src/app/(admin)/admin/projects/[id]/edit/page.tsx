        ...
        >
          ...
          <div className="mb-8 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-neutral-400">Update project information</p>
            </div>
          </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full rounded-md border border-neutral-600 bg-neutral-800/50 px-3 py-2 text-white dark:border-neutral-800"
                    >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  {features.map((feature, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 rounded border border-neutral-700 bg-neutral-800/30 p-2 dark:border-neutral-800"
                    >
